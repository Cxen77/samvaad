...
const VideoTile = ({ 
  ...
  return (
    ...
    >
      ...
      {/* Animated Hand Raised Emoji (Top-Left, No Background) */}
      {participant?.handRaised && (
        <div 
          className="absolute top-2.5 left-2.5 z-20 select-none animate-bounce"
          title={`${participant?.name || 'Participant'} raised hand`}
        >
          <span className="text-2xl drop-shadow-[0_2px_4px_rgba(0,0,0,0.6)] leading-none select-none">✋</span>
        </div>
      )}
